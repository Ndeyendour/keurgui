     ...
     const [properties, setProperties] = useState([]);
      ...
      const handleSearchClick = () => {
        if (selectedPriceRange) {
          // Si une plage de prix est définie, filtrer par prix
          navigate("/louer", {
            state: { priceRange: selectedPriceRange }, // Passez la plage de prix comme paramètre d'état
          });
        } else {
          // Si aucune plage de prix n'est définie, aller à /louer sans filtres
          navigate("/louer");
        }
      };
